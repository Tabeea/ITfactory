...
# Pentru a implementa un interator avem nevoie de o clasa care implemeneaza functiile
# * __iter__ - va returna clasa in sine
# * __next__ - va specifica mecanismul prin care se trece la urmatorul element

# iterator care primeste un numar "n" si returneaza primele "n" numere pare
